...
<body>
    <div class="container container-sm">
        <h1 class="my-3">Actualizar empleado</h1>
        <form action="<?= base_url('actualizar_empleado') ?>" method="post">
        <label for="txt_codigo" class="form-label">Código</label>
        <input type="number" name="txt_codigo" id="txt_codigo" class="form-control" value="<?= $datos['codigo_empleado'] ?>" readonly>
        <br>
        ...
        <input type="email" name="txt_correo" id="txt_correo" class="form-control" value="<?= $datos['email'] ?>">
        <br>
