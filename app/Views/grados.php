...
<body>
    ...
    <header class="container-fluid">
        <h1 class="my-3">Grados</h1>
    </header>


    <body>
        <div class="container-fluid">
            <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#gradoModal">Agregar grado</button>
            <div class="modal fade" id="gradoModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header  bg-primary">
                            <h5 class="modal-title text-light">Agregar grado</h5>
                            <button aria-label="Close" type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <form action="<?=base_url('guardar_grado')?>" method="post">
                            <label for="txt_codigo" class="form-label">Código</label>
                            <input type="number" id="txt_codigo" name="txt_codigo" class="form-control" required>
                ...
                <table class="table table-striped container container-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <?=$grado['nombre']?> </td>
                            <td>
                                <a href="<?= base_url('buscarGrado/' . $grado['codigo_grado']) ?>" class="btn btn-primary btn-sm">Actualizar</a>
                                <a href="<?= base_url('eliminarGrado/' . $grado['codigo_grado']) ?>" class="btn btn-danger btn-sm">Eliminar</a>
                            </td>
                        </tr>
                        <?php
                            endforeach;
